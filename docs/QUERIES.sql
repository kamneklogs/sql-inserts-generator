...
WHERE (
        (
            (
                EMPLOYEE.DOB BETWEEN TO_DATE('01/01/1950', 'dd/mm/yyyy') AND TO_DATE('01/01/1964', 'dd/mm/yyyy')
            )
            AND SEX = 'F'
            AND POSITION = 'Jefe'
        )
        OR (
            (
                EMPLOYEE.DOB BETWEEN TO_DATE('01/01/1950', 'dd/mm/yyyy') AND TO_DATE('01/01/1959', 'dd/mm/yyyy')
            )
            AND SEX = 'M'
            AND POSITION = 'Jefe'
        )
